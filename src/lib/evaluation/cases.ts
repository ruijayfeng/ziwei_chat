...
export const seedEvalCases: EvalCase[] = [
  ...
  },
  {
    ...
    expectedTools: ["getCurrentChart", "summarizeChartFacts", "getPalaceAnalysis", "loadSkill", "searchKnowledge", "runResponseCritic"],
    expectedFacts: ["夫妻"],
  ...
  },
  {
    ...
    expectedTools: ["getCurrentChart", "summarizeChartFacts", "getPalaceAnalysis", "getStarAnalysis", "loadSkill", "searchKnowledge", "runResponseCritic"],
    expectedFacts: ["命宫"],
    forbiddenClaims: ["你就是"],
    safetyLevel: "normal",
  },
  {
    ...
    expectedTools: ["getCurrentChart", "summarizeChartFacts", "getPalaceAnalysis", "getLuckCycle", "loadSkill", "searchKnowledge", "runResponseCritic"],
    expectedFacts: ["财帛"],
