...
export function DestinyChart() {
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[680px]" role="group" aria-label="十二宫命盘">
      ...
      {model.palaces.map((palace) => {
        ...
        return (
          <button
            ...
            className={cn(
              "absolute z-10 flex min-h-16 w-[5.25rem] -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-xl border px-2 text-center transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus sm:w-24",
              active
